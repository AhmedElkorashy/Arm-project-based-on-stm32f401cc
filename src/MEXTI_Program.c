...
u8 MEXTI_voidReadPendingFlag(MEXTI_Line copy_MEXTI_Line)
{
	u8 Reading=0;
	Reading=GET_BIT(EXTI->PR , copy_MEXTI_Line);
	return Reading;
}
...
{
	if(MEXTI_voidReadPendingFlag(5))
	{
	...
	if(MEXTI_voidReadPendingFlag(6))
	{
	...
	if(MEXTI_voidReadPendingFlag(8))
	{
